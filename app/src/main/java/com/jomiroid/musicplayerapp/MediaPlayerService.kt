...
class MediaPlayerService : Service() {
    ...
    override fun onCreate() {
        ...
        val playIcon = Icon.createWithResource(baseContext, R.drawable.play_svgrepo_com)
        val pauseIcon = Icon.createWithResource(baseContext, R.drawable.pause_svgrepo_com)
        val stopIcon = Icon.createWithResource(baseContext, R.drawable.stop_svgrepo_com)
